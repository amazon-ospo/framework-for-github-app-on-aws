...
export const getAppFrameworkServiceHandler = <Context>(service: AppFrameworkService<Context>, customizer: __ValidationCustomizer<AppFrameworkServiceOperations>): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
