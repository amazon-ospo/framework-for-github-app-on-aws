 ...
 * ```javascript
 * import { AppFrameworkClient, GetAppTokenCommand } from "@genet.example/coffee-shop-client"; // ES Modules import
 * // const { AppFrameworkClient, GetAppTokenCommand } = require("@genet.example/coffee-shop-client"); // CommonJS import
