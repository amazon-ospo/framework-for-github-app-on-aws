...
import { AppFrameworkHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
import {
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: AppFrameworkHttpAuthSchemeProvider): void;
